      ...
      <div className="container mx-auto px-8">
        ...
        >
          ...
          <div className="flex flex-col items-center text-center">
            <h4 className="font-bold text-lg mb-4 whitespace-nowrap">
          ...
          <div className="text-center md:text-center lg:text-left">
            ...
            <ul className="space-y-2">
              <li>
                <NavLink
                  to="/"
                  className="hover:underline hover:text-[#FF7A00]"
                >
                  Home
                </NavLink>
              </li>
          ...
          <div className="flex flex-col items-center order-last md:order-none lg:hidden">
            ...
            <div className="flex justify-center space-x-2.5 text-2xl">
              <a
                href="#"
                aria-label="Facebook"
                className="transition-colors duration-300 hover:text-[#FF7A00]"
              >
